...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" action="alterAddCourse" class="form-horizontal"  method="post" >
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="course_title" id="${course.course_title }" placeholder="${course.course_title }" type="text">
				</div>
			</div>
			<div class="form-group">
