	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal"  method="post" >
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="courseTitle" id="subjectTitle" placeholder="主讲人" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">所属课程</label>
				<div class="col-sm-10">
					<input class="form-control" name="courseTitle" id="subjectTitle" placeholder="所属课程" type="text">
				</div>
			</div>
			<div class="form-group">
