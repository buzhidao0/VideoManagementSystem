...
<form id="infoForm" action="alterUpdateSpeaker" class="form-horizontal" >
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
			<input class="form-control" name="speaker_name" id="subjectTitle" value="${speaker.speaker_name }" placeholder="${speaker.speaker_name }" type="text">
	    </div>
	  </div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input class="form-control" name="speaker_job" id="subjectTitle" value="${speaker.speaker_job }" placeholder="${speaker.speaker_desc }" type="text">
		</div>
	</div>
	<div class="form-group">
		<label for="subjectTitle" class="col-sm-2 control-label">头像地址</label>
		<div class="col-sm-10">
			<input class="form-control" name="pic_url" id="subjectTitle" value="${speaker.pic_url }" placeholder="${speaker.speaker_job }" type="text">
		</div>
	</div>
	<div class="form-group">
		<label for="courseDesc" class="col-sm-2 control-label">简介</label>
		<div class="col-sm-10">
			<textarea class="form-control" id="courseDesc" name="speaker_desc" rows="3">${speaker.speaker_desc }</textarea>
		</div>
	</div>
	<div class="form-group">
