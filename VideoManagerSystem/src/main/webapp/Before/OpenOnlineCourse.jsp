...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link rel="icon" href="http://localhost:8080/VideoManagementSystem2/Resource/z/favicon.png" type="image/png">
		...
		<span>欢迎来到IT培训的黄埔军校——智游教育！</span>
			...
			<div id="userBlock" style="float:right">
				<c:if test="${!empty sessionKey}">
					...
					<a href="exit">退出</a>
					<a href="showEachCenter?accounts=${sessionKey.accounts }"><img src="${pageContext.request.contextPath }/Resource/z/user.png" draggable="false">个人中心</a>
				</c:if>
				<c:if test="${empty sessionKey}">
				<a id="login_open"><img src="${pageContext.request.contextPath }/Resource/z/we.png">登录</a>
				</c:if>
<%-- 				href="${pageContext.request.contextPath }/index.jsp" --%>
				<c:if test="${empty sessionKey}">
					<a id="reg_open"><img src="${pageContext.request.contextPath }/Resource/z/user.png">注册</a>
				</c:if>
			</div>
		<a onclick="JavaScript:addFavorite2()"><img src="${pageContext.request.contextPath }/Resource/z/sc.png" draggable="false">加入收藏</a>
		<a target="_blank" href="speakerShow"><img src="${pageContext.request.contextPath }/Resource/z/we.png" draggable="false">后台管理</a>
