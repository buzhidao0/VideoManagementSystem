...
<link rel="stylesheet" href="${pageContext.request.contextPath }/WbYx/Resource/z/profile.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/WbYx/Resource/js/jquery.css">
		...
		<div class="container clearfix">
			...
			<div id="user_bar">
				<a href="showEachCenter">
					<img id="avatar" src="${pageContext.request.contextPath }/WbYx/Resource/z/avatar_lg.png" alt=""width="30px;">
				</a>
				<a href="exit">退出</a>
			</div>
		</div>
	    ...
	    <div class="proflle_tab_body">
	        <div class="proflle_tab_workplace clearfix">
	            <div class="profile_avatar_area">
	                     <img src="${pageContext.request.contextPath }/WbYx/Resource/z/avatar_lg.png">
	                <p style="text-align: center;">当前头像</p>
	            </div>
	            <div class="profile_ifo_area">
	                <form id="upload_form" action="upload" method="post" enctype="multipart/form-data">
	                    <!-- hidden crop params -->
						<input type="hidden" name="accounts" value="${sessionKey.accounts }">
	                    <p>第一步：请选择图像文件</p>
	                    <div>
...
<footer>
	<div class="container">
		<ul>
			...
			<li>版权所有：智游3G教育　　　© &nbsp;&nbsp; http://www.zhiyou100.com</li>
...
<script src="${pageContext.request.contextPath }/WbYx/Resource/js/Jcrop_upload.js"></script>
</body>
</html>